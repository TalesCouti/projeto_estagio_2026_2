...
Inclui calendario com disponibilidade por dia, bloqueio de conflito no banco, filtros no painel, alteracao de status, contadores no painel, validacao no backend e tratamento para banco indisponivel.

## O que ficou de fora

Nao implementei envio de email, telefone do paciente, reagendamento, paginacao e agenda por medico. Essas partes deixariam o sistema mais completo, mas aumentariam o escopo inicial.
